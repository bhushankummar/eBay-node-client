    ...
    _request: function (method, path, data, auth, options, callback) {
        ...
        function makeRequest() {
            ...
            if (options.api === 'finding') {
                ...
                // debug('Inside finding call : findingApiHost', self._eBay.getApiField('findingApiHost'));
            ...
            if (options.api === 'shopping') {
                ...
                // debug('Inside shopping call : findingApiHost', self._eBay.getApiField('findingApiHost'));
            ...
            var req = {};
            if (options.api === 'shopping') {
                // debug('Inside secure connection shopping API call.');
